      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="card">
            ...
            {success && (
              <div className="mb-6 p-4 bg-success-100 border border-success-400 text-success-700 rounded-md">
                Thank you for your message! We'll get back to you soon.
              </div>
            )}
            
            {error && (
              <div className="mb-6 p-4 bg-danger-100 border border-danger-400 text-danger-700 rounded-md">
                {error}
              </div>
            )}
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    info@cookingcert.com<br />
                    support@cookingcert.com
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Visit our campus and experience our state-of-the-art facilities
            </p>
          </div>
          ...
          <div className="bg-gray-200 rounded-lg h-96 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400 mt-2">123 Cooking Street, Food City, FC 12345</p>
            </div>
          </div>
        </div>
      </section>
